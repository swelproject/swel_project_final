        ...
        <div id="container">
            ...
            <div class="blue-page left">
                <div class="bg-blue-center-title left">
                    <div class="wrapper">
                        <div class="title-pages left" style="font-family:myfont;text-transform:capitalize">صندوق الرسائل</div><!--/wrapper-->
                        <div class="breadcrumbs-content"><ul>
                                <li><a href="<?php echo base_url(); ?>site/logout">تسجيل الخروج</a></li><li class="current"><?php
                            if (isset($username)) {
                                echo $username;
                            }
                                ?></li><li>صندوق الرسائل</li> <li><a href="<?php echo base_url(); ?>site/">الحساب الشخصي</a></li>  <li style="background: none; padding: 0;">: انت في</li>
            ...
            <div class="content left">
                <div class="wrapper">
                    ...
                    <div class="left-page left">
						...
						<img id="mail_icon" src="<?php echo base_url();?>images/mail.png" />	
                        <p id="sender">رساله من </p>
                        <p id="sender" style="padding:0 5px 0 5px;color:#3C6"><a style="color:#3C6" id="user" href="#">mohamed temraz</a></p>
                        <p id="sender"><a href="#">واكيد فيه جيل اوصافه غير نفس الاوصاف</a></p>
