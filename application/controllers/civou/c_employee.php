...
class c_employee extends CI_Controller {
    ...
    function addEmployee() {
        ...
        $this->form_validation->set_rules('num_service', 'num_service', 'required|trim|max_length[100]|xss_clean');
        //c_id 	sc_id
...
//            $this->loadAddCategory();
            ...
            $c_id = $this->input->post('search_category');//num_service
            $sc_id = $this->input->post('sub_category');
            $num_service = $this->input->post('num_service');
            $data = array(
                'username' => $username,
                'pass' => md5($pass),
                'name' => $name,
