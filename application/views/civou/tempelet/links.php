        ...
        <script src="<?php echo base_url(); ?>_js/custom.js" type="text/javascript" ></script> 
        <!-- Ticker -->	
        ...
        <script src="<?php echo base_url(); ?>_js/jquery.ticker.js" type="text/javascript"></script>
        <script src="<?php echo base_url(); ?>_js/site.js" type="text/javascript"></script>
